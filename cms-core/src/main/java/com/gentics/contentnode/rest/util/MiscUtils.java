...
public class MiscUtils {
	 ...
	 * @return
	 */
	protected static boolean isKnownFileDataBodyPartName(String name, String customFileDataBodyPartName) {
		return UPLOADIFY_DEFAULT_DATA_BODY_PART_KEY.equalsIgnoreCase(name) || BLUEIMP_DATA_BODY_PART_KEY.equalsIgnoreCase(name)
				|| QQFILE_DATA_BODY_PART_KEY.equalsIgnoreCase(name) || UPLOADIFY_DATA_BODY_PART_KEY.equalsIgnoreCase(name)
	 ...
	 */
	public static BodyPart getFileDataBodyPart(MultiPart multiPart, String customFileDataBodyPartName) {
	 ...
	 */
	public static FileUploadMetaData getMetaData(MultiPart multiPart, String customFileDataBodyPartName)
			throws WebApplicationException  {
			...
			if (isKnownFileDataBodyPartName(currentBodyPartName, customFileDataBodyPartName)) {
				...
				try {
					...
					if (entity instanceof BodyPartEntity) {
						value = IOUtils.toString(((BodyPartEntity) entity).getInputStream(), StandardCharsets.UTF_8);
	 ...
	 */
	public static void checkImplicitRestorePermissions(LocalizableNodeObject<?> obj)
	 ...
	 */
	public static Set<Integer> getFileUsageIds(List<Integer> objId, int objType, Integer nodeId, boolean isImage) throws NodeException {
		Transaction t = TransactionManager.getCurrentTransaction();
		PreparedStatement pst = null;
		ResultSet res = null;

		try {
			String idPlaceholders = com.gentics.lib.etc.StringUtils .repeat("?", objId.size(), ",");
			String typeIds = null;
			String dsTypes = null;
	 ...
	 */
	public static FileUsageListResponse getFileUsage(Integer skipCount,
	 ...
	 */
	public static Set<Integer> getFolderUsageIds(List<Integer> objId, int objType) throws NodeException {
		Transaction t = TransactionManager.getCurrentTransaction();
		PreparedStatement pst = null;
		ResultSet res = null;
	 ...
	 */
	public static TotalUsageResponse getTotalUsageInfo(Map<Integer, Integer> masterMap, int type, Integer nodeId) throws NodeException {
	 ...
	 */
	public static FolderUsageListResponse getFolderUsage(Integer skipCount, Integer maxItems, String sortBy, String sortOrder, int objType, List<Integer> objId, Integer nodeId,
	 ...
	 */
	public static boolean checkFolderPermission(Integer folderId, int permBit) throws NodeException {
		PermHandler permHandler = TransactionManager.getCurrentTransaction().getPermHandler();
	 ...
	 */
	public static boolean checkFolderPermissions(Folder folder, PermHandler.ObjectPermission... perms) throws NodeException {
		boolean perm = true;
	...
	public static class FileUploadMetaData extends Properties {
	 ...
	 */
	public static class ItemComparator extends AbstractComparator implements Comparator<ContentNodeItem> {
		...
		public int compare(ContentNodeItem i1, ContentNodeItem i2) {
			...
			case NAME:
				cmp = com.gentics.lib.etc.StringUtils.mysqlLikeCompare(i1.getName(), i2.getName()) * way;
				break;
			...
			case TEMPLATE:
				cmp = com.gentics.lib.etc.StringUtils.mysqlLikeCompare(getTemplateName(i1), getTemplateName(i2)) * way;
				break;
