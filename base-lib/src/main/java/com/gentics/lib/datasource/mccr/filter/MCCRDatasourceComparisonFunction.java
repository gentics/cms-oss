...
public class MCCRDatasourceComparisonFunction extends AbstractGenericBinaryFunction {
	...
	/**
	 * Generate the filter part for "equals" or "unequals" comparisons. Make sure that also null is treated correctly
	 * 
	 * @param functionType
	 *            function type (either TYPE_EQUAL or TYPE_UNEQUAL)
	 * @param request
	 *            expression request
	 * @param filterPart
	 *            filter part
	 ...
	 */
	protected void generateNullSafeFilterPart(int functionType, ExpressionQueryRequest request, FilterPart filterPart, EvaluableExpression[] operand,
			int expectedValueType) throws ExpressionParserException {
	...
	protected void variableWithStaticComparison(int functionType, ExpressionQueryRequest request, FilterPart filterPart,
			EvaluableExpression variableOperand, EvaluableExpression staticOperand) throws ExpressionParserException {
		try {
	...
	protected void simpleComparison(int functionType, ExpressionQueryRequest request, FilterPart filterPart, EvaluableExpression[] operand) throws ExpressionParserException {
		filterPart.addFilterStatementPart("(");
	...
	/**
	 * Inner helper class that generates a filterpart for "==" and "!=" comparisons in case one of the operands is nonstatic and the other is variable
	 */
	public class EqualityGenerator implements FilterPartGenerator {
		...
		/**
		 * static operand (when the filter is generated, this operand is nonstatic, but when the generator generates the filterpart it becomes static, since we may
		 * resolve now)
		 */
		 ...
		 *            function type
		 */
		public EqualityGenerator(EvaluableExpression variableExpression, EvaluableExpression staticExpression, int functionType) {
