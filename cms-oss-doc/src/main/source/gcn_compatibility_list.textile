...
| 11             | 11.0-11.6      | Yes        |                          |
| 10             | 10.4-10.11     | Yes[1]     | Since Gentics CMS 6.0.0  |
...
Compatibility with operating systems is determined by the available Java and database versions. Gentics CMS needs at least Java 17 and MariaDB 10.4 or MySQL 5.1.
...
fn1. Yes¹ - Tested using automatic tests.

fn2. Yes² - Tested using periodic manual tests.
