...
All customer-specific configuration and code should reside in the "ui-conf":admin_configuration.html#ui_conf_path directory. The structure of this folder should be as follows:
