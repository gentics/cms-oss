 ...
 * @date Jan 31, 2011
 * @version $Id: NodeDescriptionInputChannel.java,v 1.1.2.2 2011-03-07 18:42:00 tobiassteiner Exp $
 */
...
public class NodeDescriptionInputChannel extends FallbackInputChannel {
	@Override
	public Policy getSpecificPolicy(PolicyMap map) {
		return map.getNodeDescriptionPolicy();
	}
}
