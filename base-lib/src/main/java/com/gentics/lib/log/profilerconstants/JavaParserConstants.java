...
public abstract class JavaParserConstants {
	...
	public final static String PUBLISHER_IMAGERESIZER = PUBLISHER_WRITEFS + "/resizer";
    
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_QUERY = PUBLISHER_IMAGERESIZER + "/query";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_CREATECACHEKEY = PUBLISHER_IMAGERESIZER + "/createCacheKey";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_GETINFO = PUBLISHER_IMAGERESIZER + "/getInfo";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_GETCACHE = PUBLISHER_IMAGERESIZER + "/getCache";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_PUTCACHE = PUBLISHER_IMAGERESIZER + "/putCache";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_WRITE = PUBLISHER_IMAGERESIZER + "/write";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_RESIZE = PUBLISHER_IMAGERESIZER + "/resize";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_GETALLINFO = PUBLISHER_IMAGERESIZER + "/getAllInfo";
	public final static String PUBLISHER_WRITEFS_IMAGERESIZER_HANDLEPAGE = PUBLISHER_IMAGERESIZER + "/handlePage";
