...
<shell>/cms$ java -cp cms-server.jar com.gentics.contentnode.tools.UpdateImplementation -f update.yml</shell>

or via command-line parameters:

<shell>/cms$ java -cp cms-server.jar com.gentics.contentnode.tools.UpdateImplementation -u node -p secret -P baseimplementation gallery</shell>
