...
describe('FileDropAreaDirective', () => {
    ...
    afterEach(inject([PageFileDragHandlerService], (pageDrag: PageFileDragHandlerService) => {
        pageDrag.destroy();
    }));
...
class TestComponent {
    ...
    directive: FileDropAreaDirective;

    @ViewChildren(FileDropAreaDirective)
    directives: QueryList<FileDropAreaDirective>;
