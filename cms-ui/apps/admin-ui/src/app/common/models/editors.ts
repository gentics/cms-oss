...
export type EditableEntityAPIModels = {
    [EditableEntity.CONSTRUCT]: {
        ...
        [EntityModelType.UPDATE_REQUEST_PARAMS]: void,
        [EntityModelType.UPDATE_RESPONSE_MODEL]: ConstructUpdateResponse,
        [EntityModelType.DELETE_REQUEST_MODEL]: void,
        [EntityModelType.DELETE_REQUEST_PARAMS]: void,
        [EntityModelType.LIST_REQUEST_MODEL]: void,
        ...
        [EntityModelType.DEV_TOOL_LIST_REQUEST_MODEL]: void,
    ...
    [EditableEntity.CONSTRUCT_CATEGORY]: {
        ...
        [EntityModelType.CREATE_REQUEST_PARAMS]: void,
        ...
        [EntityModelType.DEV_TOOL_LIST_REQUEST_MODEL]: void,
        [EntityModelType.DEV_TOOL_LIST_REQUEST_PARAMS]: void,
        [EntityModelType.DEV_TOOL_LIST_RESPONSE_MODEL]: void,
    },
    ...
    [EditableEntity.DEV_TOOL_PACKAGE]: {
        ...
        [EntityModelType.UPDATE_REQUEST_PARAMS]: void,
        [EntityModelType.UPDATE_RESPONSE_MODEL]: void,
        [EntityModelType.DELETE_REQUEST_MODEL]: void,
        [EntityModelType.DELETE_REQUEST_PARAMS]: void,
        [EntityModelType.LIST_REQUEST_MODEL]: void,
    ...
    [EditableEntity.TEMPLATE]: {
        ...
        [EntityModelType.LIST_RESPONSE_MODEL]: FolderTemplateListResponse,
        [EntityModelType.DEV_TOOL_LIST_REQUEST_MODEL]: void,
