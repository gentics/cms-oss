...
export class SpyEventTarget implements EventTarget {
    ...
    constructor(public name: string = '') {
        spyOn(this as any, 'addEventListener').and.callThrough();
        spyOn(this as any, 'dispatchEvent').and.callThrough();
        spyOn(this as any, 'removeEventListener').and.callThrough();
    }
    ...
    triggerListeners<T>(type: string, data?: T): T & Event {
        ...
        let eventData = data ? Object.create(Object.getPrototypeOf(data)) : {};
        let properties = {
            defaultPrevented: false,
            preventDefault(): void { this.defaultPrevented = true; },
            propagationStopped: false,
