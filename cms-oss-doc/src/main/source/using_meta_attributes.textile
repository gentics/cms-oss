...
WARNING: Rendering tags in edit mode via the Node-Style syntax can cause problems, if the template contains "@<@" or "@>@" characters (for example @<?php ... ?>@). Consider using the @#gtx_edit@.
