...
NOTE: Place the JDBC driver at @/Node/node/java/lib/@
...
Use the following example for @/Node/etc/sync.properties@ to log to 
@/Node/node/log/crsync.log@.

<shell filename="/Node/etc/sync.properties">
