...
<shell>
{{gtx_gis image [width=value] [height=value] [mode=value] [type=value] [crop_width=value] [crop_heigth=value] [crop_x=value] [crop_y=value]}}
</shell>
...
| +heigth+ | Height of the resized image | *auto* |
