 ...
 */
public abstract class AbstractMeshPublishRoleTest {
	/**
	...
	protected final static String TPL_OBJECT_TAG_KEYWORD = "vtlroles";
	protected final static String TPL_PART_KEYWORD = "vtl";
	protected final static String TPL_ROLES_FIELD = "roles";
	...
	protected static Datasource rolesDs;

	protected static Construct rolesConstruct;

	protected static ObjectTagDefinition rolesProperty;
	...
	public void testFolderPermissionsWithoutDs() throws Exception {
		...
		Trx.operate(() -> update(folder, f -> setTemplateRoles(f, "role_a", "role_c")));
	...
	public void testPagePermissionsWithoutDs() throws Exception {
		...
		update(folder, f -> setTemplateRoles(f, "role_a", "role_c"));
	...
	public void testProjectPermissionsWithoutDs() throws Exception {
		setVelocityPermissionProperty();
		setTemplateRoles(node.getFolder(), "anonymous", "role_b");
	 ...
	 */
	protected abstract void setVelocityPermissionProperty() throws NodeException;
	 ...
	 */
	protected abstract void setTemplateRoles(ObjectTagContainer container, String... roles) throws NodeException;
