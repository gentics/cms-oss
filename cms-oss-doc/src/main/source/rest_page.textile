...
<javascript>
POST /CNPortletapp/rest/page/create
{
...
<javascript>
GET /CNPortletapp/rest/page/load/{id}
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/save/{id}
{
  page: ..;   // the page
...
<javascript>
POST /CNPortletapp/rest/page/preview
{
  page: ..;
}
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/delete/{id}
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/restore/{id}?version=..
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/translate/{id}?language=..
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/publish/{id}
{
  "message" : ..;
}
</javascript>
...
<javascript>
POST /CNPortletapp/rest/page/workflow/decline/{id}
{
  "message" : ..;
  "group" : ..;
  "delete" : ..;
...
Parameters for /CNPortletapp/rest/page/workflow/decline
...
<javascript>
POST /CNPortletapp/rest/page/workflow/revoke/{id}
</javascript>