...
export const animateCubicBezier = (millis: number): any => animate(`${millis}ms cubic-bezier(0.215, 0.61, 0.355, 1)`);
...
export class SideMenuComponent implements AfterViewInit {
    ...
    constructor(
        ...
        private userAgentRef: UserAgentProvider,
    ) { }
