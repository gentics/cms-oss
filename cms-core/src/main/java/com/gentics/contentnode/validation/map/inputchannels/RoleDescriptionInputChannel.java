 ...
 * @date Mar 6, 2011
 * @version $Id: RoleDescriptionInputChannel.java,v 1.1.2.1 2011-03-07 18:42:00 tobiassteiner Exp $
 */
...
public class RoleDescriptionInputChannel extends FallbackInputChannel {
	@Override
	public Policy getSpecificPolicy(PolicyMap map) {
		return map.getRoleDescriptionPolicy();
	}
}
