...
All characters that are not allowed in filenames are replaced with an hyphen by default. You can however redefine the standard replacement character like this:
<shell filename="conf/*.yml">
