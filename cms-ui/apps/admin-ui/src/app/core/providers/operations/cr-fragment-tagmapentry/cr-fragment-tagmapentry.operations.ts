...
export class ContentRepositoryFragmentTagmapEntryOperations extends ExtendedEntityOperationsBase<'tagmapEntry'> {
    ...
    create(
        ...
        return this.api.contentRepositoryFragments.createContentRepositoryFragmentTagmapEntry(contentRepositoryId, payload).pipe(
    ...
    update(
        ...
        return this.api.contentRepositoryFragments.updateContentRepositoryFragmentTagmapEntry(contentRepositoryId, tagmapId, payload).pipe(
    ...
    delete(
        ...
        return this.api.contentRepositoryFragments.deleteContentRepositoryFragmentTagmapEntry(contentRepositoryId, tagmapId).pipe(
            // display toast notification
            tap(() => {
