...
import { ATTR_CONTENT_TYPE, ATTR_LINK_TYPE, ATTR_TARGET, ATTR_URL, RichContentLinkType, RichContentType } from '../../models';
...
describe('RichContentEditorComponent', () => {
    ...
    describe('Simple setup', () => {
        ...
        it('should display rich-content links correctly', () => {
            ...
            cy.mount(RichContentEditorComponent, {
                componentProperties: {
                    value: VALUE,
                },
            })
        ...
        it('should be able to create a new link and emit a properly encoded valueChange', () => {
            ...
            cy.mount(TestComponent, {
                ...
                .then(() => {
                    ...
                    cy.get('@modal')
                        .find('[data-control="displayText"] input')
                        .type('{selectAll}Example');

                    cy.get('@modal')
                        .find('[data-control="linkType"] .select-input')
                        .click({ force: true });
