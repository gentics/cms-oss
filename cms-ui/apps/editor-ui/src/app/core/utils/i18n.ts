import { formatI18nDate, I18nService } from '@gentics/cms-components';
...
export function getFormattedTimeMgmtValue(
    ...
    function toDateString(dateRaw): string {
        return dateRaw > 0
            ? formatI18nDate(dateRaw, i18n.getCurrentLanguage(), 'dateTime')
            : i18n.instant('editor.publish_queue_date_value_immediately');
    }
    ...
    function getCompatiblityPageValue(page: Page): Observable<string> {
        ...
        if (page.versions) {
            ...
            return of(i18n.instant('editor.publish_queue_date_version_value_label', { date, user, version }));
        }
        ...
        return from(folderActions.getPage(page.id, {
            ...
            map((versionedPage) => {
                ...
                return i18n.instant('editor.publish_queue_date_version_value_label', { date, user, version });
            }),
        );
    }
    ...
    switch (field) {
        ...
        case 'at': {
            ...
            user = i18n.instant('editor.publish_queue_migration_notice');
            // SPECIAL CASE
        ...
        case 'offlineAt':
            ...
            if (user) {
                return of(i18n.instant('editor.publish_queue_date_value_label', { date, user }));
            } else {
                return of(date);
            }
