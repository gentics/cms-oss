...
# ExecStart=java -Duser.dir=/cms -Dcom.gentics.contentnode.config.files=cms -cp cms-oss-server.jar --add-opens=java.base/java.lang=ALL-UNNAMED com.gentics.contentnode.server.Runner
ExecStart=java -Duser.dir=/cms -Dcom.gentics.contentnode.config.files=cms -cp cms-server.jar --add-opens=java.base/java.lang=ALL-UNNAMED com.gentics.contentnode.server.Runner
