...
/**
 * Sandbox test for the CnMapPublishHandlers with mccr=false
 */
@RunWith(value = Parameterized.class)
public class CnMapPublishHandlerSandboxBTest extends AbstractCnMapPublishHandlerSandboxTest {
	/**
	 ...
	 */
	public CnMapPublishHandlerSandboxBTest(boolean mccr, boolean instantPublishing, boolean diffDelete) {
