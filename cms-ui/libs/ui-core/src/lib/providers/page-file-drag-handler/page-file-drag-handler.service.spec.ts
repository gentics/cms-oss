...
describe('PageDragDropFileHandler Service', () => {
    ...
    let service: PageFileDragHandlerService;

    beforeEach(() => {
        spyPageElement = new SpyEventTarget();
        let dragStateTrackerFactory = new DragStateTrackerFactoryService();
        service = new PageFileDragHandlerService(spyPageElement, dragStateTrackerFactory);
    });
