    ...
    implements com.gentics.lib.datasource.object.jaxb.Definition, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.gentics.lib.datasource.object.jaxb.impl.runtime.UnmarshallableObject, com.gentics.lib.datasource.object.jaxb.impl.runtime.XMLSerializable, com.gentics.lib.datasource.object.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.gentics.lib.datasource.object.jaxb.Definition.class);
    }
    ...
    public com.gentics.lib.datasource.object.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.gentics.lib.datasource.object.jaxb.impl.runtime.UnmarshallingContext context) {
        return new com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.Unmarshaller(context);
    }
...
+";L\u0000\fnamespaceURIq\u0000~\u0000!xq\u0000~\u0000\u001ct\u00001com.gentics.lib.datasource.obj"
+"ect.jaxb.Objecttypet\u0000+http://java.sun.com/jaxb/xjc/dummy-ele"
...
+"Pool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\tq\u0000~\u0000\u0012q\u0000~\u0000\u0014q\u0000~\u0000\u0015q\u0000~\u0000%q\u0000~\u0000@q\u0000~\u0000\u000eq\u0000~\u0000\u000bx"));
        ...
        extends com.gentics.lib.datasource.object.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("objecttype" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((com.gentics.lib.datasource.object.jaxb.impl.DefinitionTypeImpl)com.gentics.lib.datasource.object.jaxb.impl.DefinitionImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
