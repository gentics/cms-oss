...
Compatibility with operating systems is determined by the available Java and database versions. Gentics CMS needs at least Java 11 and MariaDB 10.4 or MySQL 5.1.
