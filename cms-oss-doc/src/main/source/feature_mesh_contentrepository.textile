...
h4. Exclude from indexing

With setting the arbitrary field's "Exclude from indexing" flag one can make the published data of a field to be omitted during the search indexing process, to prevent sensitive data leak.
