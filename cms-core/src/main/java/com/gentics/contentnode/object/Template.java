...
public interface Template extends TagContainer, GCNRenderable, ObjectTagContainer, LocalizableNodeObject<Template>, Resolvable, SynchronizableNodeObject, NamedNodeObject, MetaDateNodeObject {
	/**
