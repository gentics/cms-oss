...
WARNING: Tag references other than using the _<node [tagname]>_ notation will +not+ be detected and updated. This especially includes tag references using Handlebars.
