...
export class GCMSRestClient implements GCMSRootAPI {
    ...
    public folder: GCMSFolderAPI = {
        ...
        getMultiple: (body) => this.executeMappedJsonRequest(GET, '/folder/load', body),
    ...
    public node: GCMSNodeAPI = {
        ...
        update: (id, body) => this.executeMappedJsonRequest(PUT, `/node/${id}`, body),
    ...
    public page: GCMSPageAPI = {
        ...
        getMultiple: (body) => this.executeMappedJsonRequest(GET, '/page/load', body),
