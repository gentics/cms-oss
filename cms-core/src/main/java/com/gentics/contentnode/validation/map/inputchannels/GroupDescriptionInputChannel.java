 ...
 * @date Mar 6, 2011
 * @version $Id: GroupDescriptionInputChannel.java,v 1.1.2.1 2011-03-07 18:42:00 tobiassteiner Exp $
 */
...
public class GroupDescriptionInputChannel extends FallbackInputChannel {
	@Override
	public Policy getSpecificPolicy(PolicyMap map) {
		return map.getGroupDescriptionPolicy();
	}
}
