...
| "json_path":#json_path | Navigate over a "JSON":gcn_part_types.html part type using "JSONPath":https://goessner.net/articles/JsonPath/ | +{{json_path cms.tag.parts.json "$.objarray[0].objfield"}}+ |
...
<shell>
{{json_path [object] [JSONPath-string]}}
</shell>
