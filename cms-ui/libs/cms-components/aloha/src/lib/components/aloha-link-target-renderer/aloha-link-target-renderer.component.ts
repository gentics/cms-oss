...
export class AlohaLinkTargetRendererComponent
    ...
    public pickInternalTarget(): void {
        ...
        this.gcmsUiServices.openRepositoryBrowser({
            ...
            path = `${(this.loadedTargetElement).path}${path}`;
            ...
            this.triggerChange({
                ...
                internalTargetId: this.loadedTargetElement.id,
                internalTargetType: this.loadedTargetElement.type,
                internalTargetLang: (this.loadedTargetElement as any).language || '',
                internalTargetNodeId: (this.loadedTargetElement as any).nodeId,
            });
        });
    }
