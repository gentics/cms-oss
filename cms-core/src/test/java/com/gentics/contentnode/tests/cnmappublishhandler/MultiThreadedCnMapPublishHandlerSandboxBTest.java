...
public class MultiThreadedCnMapPublishHandlerSandboxBTest extends AbstractMultiThreadedCnMapPublishHandlerSandboxTest {
	 ...
	 */
	public MultiThreadedCnMapPublishHandlerSandboxBTest(boolean mccr, boolean instantPublishing, boolean diffDelete) {
