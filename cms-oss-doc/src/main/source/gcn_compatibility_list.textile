...
| 2.7            | 2.7.0           | Yes¹       | Default CMS JDBC connector (shipped) |
...
h4. Microsoft Internet Explorer

No version of Microsoft Internet Explorer is supported by Gentics CMS, please use one of our other supported browsers.
