 ...
 * @date Jan 30, 2011
 * @version $Id: AntiSamy_no.java,v 1.1.2.1 2011-02-10 13:43:38 tobiassteiner Exp $
 */
 ...
 */
public class AntiSamy_no extends FallbackResourceBundle {
	public AntiSamy_no() {
		super("AntiSamy", new Locale("no", "NB"));
	}
}
