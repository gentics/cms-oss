...
import { I18nService } from '../../../core/providers/i18n';
import { InitializableServiceBase } from '../../providers';
...
@Injectable()
export class GtxI18nRelativeDateService extends InitializableServiceBase {
