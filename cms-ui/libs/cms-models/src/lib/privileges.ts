...
export interface GcmsRolePrivilegeMapCollection {
    ...
    file: Omit<GcmsRolePrivilegeMap, GcmsRolePrivilege.PUBLISH_PAGES | GcmsRolePrivilege.TRANSLATE_PAGES>;

}

/** Maps each privilege to its corresponding GcmsPermission. */
export const GCMS_ROLE_PRIVILEGES_TO_GCMS_PERMISSIONS_MAP: Record<GcmsRolePrivilege, GcmsPermission | null> = Object.freeze({
