...
Every +.groovy+ file located in the directory @/cms/packages/[package]/scripts/@ is interpreted as groovy script or groovy class. See "Groovy Scripts in Devtool Packages":groovy.html#groovy-scripts-in-devtool-packages for details.
